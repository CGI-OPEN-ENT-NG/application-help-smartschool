...
![](.gitbook/assets/1dashboard_parents.png)
...
![](.gitbook/assets/2acces_vuecalendaire.png)
...
![](.gitbook/assets/uni-parametres%20%283%29.png) _Le nombre maximal d'oublis de carnet toléré avant le déclenchement d'une alerte est paramétrable._
...
Le registre permet de **consulter tous les événements d'une classe sur un mois**. Il est accessible directement depuis la page d'accueil en rentrant le nom de la classe. ![](.gitbook/assets/1champ_recherche_registre.png)
...
![](.gitbook/assets/uni-parametres%20%286%29.png) _Les périodes de fermeture sont paramétrables. Et par défaut, si aucun cours n'est positionné sur un jour sur l'année scolaire, ce jour est grisé dans le tableau. Cela permet d'afficher grisés les samedi et dimanche par exemple, s'il n'y a pas cours ces jours-là._
...
* **Si l'élève a été absent lors du dernier cours de l'enseignant**, un petit icône le lui signale ![](.gitbook/assets/4absent_derniercours.png)
...
* **Si l'élève a oublié son carnet de correspondance**, un petit icône le signale à l'enseignant.![](.gitbook/assets/4carnet_oublie.png)
...
![](.gitbook/assets/5table_edit%20%281%29.png) Le clic sur l'icone à côté des périodes permet **d'accéder directement à la vue calendaire de l'élève** pour saisir un événement sur la journée ou sur une période plus longue.
...
![](.gitbook/assets/uni-parametres%20%281%29.png) _Les types d'actions et leurs abréviations sont paramétrables_.
...
![](https://github.com/opendigitaleducation/application-help-2d/tree/8f560d03ad1f52ea27a2a8907eeb5d8f119ae92e/application/.gitbook/assets/img_cgi/presences/9presence_calendaire.png)
...
En cliquant sur une ligne il est possible d'en afficher les détails. ![](.gitbook/assets/10detail_incident.png)
...
* En fonction du type choisis, de nouveaux champs vont apparaître pour entrer des dates, des heures etc...
  ...
  ![](.gitbook/assets/11types_punition.png)
...
![](.gitbook/assets/uni-parametres%20%285%29.png) _Les types de punitions et sanctions sont paramétrables._
